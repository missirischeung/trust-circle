  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6">
        {user.role === "agent" ? (
          // Field agents only see a simplified data collection interface
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold">Field Data Collection</h2>
                <p className="text-muted-foreground">Submit field observations and attach supporting materials</p>
              </div>
            </div>
            <DataSubmissionForm userRole={user.role} />
          </div>
        ) : (
          // Partners and Admins see the full dashboard
